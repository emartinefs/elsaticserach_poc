...
public class PersonPageAction extends ActionSupport{
	...
	public String savePersonData()
	{
		...
		searchBean.saveData(personData.getPersonId(), personData.getFirstName(),personData.getLastName(), personData.getCompany(),personData.getDepartment(),personData.getTitle(),personData.getSsn(),personData.getDob());;
